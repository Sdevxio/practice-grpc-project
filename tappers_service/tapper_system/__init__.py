...
Main Components:
    ...
    Commands: Modern dual card sequences and legacy operations (command/)
...
Example Usage:
    ...
    from tappers_service.tapper_system.command import legacy_sequences  # For backward compatibility
